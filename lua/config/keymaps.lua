...
-- KEYBINDS:
-- save and close
vim.keymap.set({ "n", "v", "i" }, "<D-s>", vim.cmd.w, { desc = "Save" })
vim.keymap.set({ "n", "i", "v" }, "<D-d>", vim.cmd.q, { desc = "Save and Quit" })
...
vim.keymap.set({ "n", "v", "o" }, "<S-j>", "<S-Left>", { desc = "Move word left" })
vim.keymap.set({ "n", "v", "o" }, "<S-l>", "<S-Right>", { desc = "Move word right" })
